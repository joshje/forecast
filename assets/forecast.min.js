...
(function(){var a=0,b=document.createElement("span");b.className="support";b.innerHTML="Loading";document.getElementsByTagName("body")[0].appendChild(b);var d=setInterval(function(){100>b.offsetWidth?(clearInterval(d),document.getElementsByTagName("html")[0].className=""):10<=++a&&(clearInterval(d),document.getElementsByTagName("html")[0].className="no-liga")},50)})();
